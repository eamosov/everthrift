...
public class ThriftCallFuture<T> extends CompletableFuture<T> {
    ...
    public ThriftCallFuture(ThriftServicesDb.ThriftMethodEntry thriftMethodEntry, TBase args) {
        super();
    ...
    public String toString() {
        return "InvocationInfo [" + thriftMethodEntry.getFullMethodName() + "(" + args + "), seqId=" + seqId + "]";
    }
}