...
public abstract class Migration {
     ...
     * @return whether the cluster reached schema agreement, or {@code true} for
     * a non schema-altering statement.
     */
     ...
     * they don't agree, or if the check could not be performed (for example, if
