...
package org.everthrift.elastic.pilato;
...
public class IndexElasticsearchUpdater {
     ...
     * @throws Exception
     */
    public static void createIndex(Client client, String root, String indexPrefix, String index, boolean force) throws Exception {
        String settings = IndexSettingsReader.readSettings(root, index);
        createIndexWithSettings(client, indexPrefix + index, settings, force);
    }
     ...
     * @throws Exception
     */
    private static void createIndex(Client client, String indexPrefix, String index, boolean force) throws Exception {
     ...
     * @throws Exception
     */
    private static void createIndexWithSettings(Client client, String index, String settings, boolean force) throws Exception {
     ...
     * @throws Exception
     */
    private static boolean isIndexExist(Client client, String index) throws Exception {
     ...
     * @throws Exception
     */
    public static void updateSettings(Client client, String root, String indexPrefix, String index) throws Exception {
        String settings = IndexSettingsReader.readUpdateSettings(root, index);
        updateIndexWithSettingsInElasticsearch(client, indexPrefix + index, settings);
    }
     ...
     * @throws Exception
     */
    private static void updateSettings(Client client, String indexPrefix, String index) throws Exception {
