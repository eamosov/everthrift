...
public class TypeElasticsearchUpdater {
     ...
     * @throws Exception
     */
    private static void createMapping(Client client, String indexPrefix, String index, String type, boolean merge) throws Exception {
        String mapping = TypeSettingsReader.readMapping(index, type);
        createMappingWithJson(client, indexPrefix + index, type, mapping, merge);
    }
     ...
     * @throws Exception
     */
    public static void createMapping(Client client, String root, String indexPrefix, String index, String type, boolean merge)
        throws Exception {
     ...
     * @throws Exception
     */
    private static boolean isTypeExist(Client client, String index, String type) throws Exception {
