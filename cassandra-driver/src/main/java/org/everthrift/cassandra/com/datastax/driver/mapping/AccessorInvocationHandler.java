...
class AccessorInvocationHandler<T> implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method m, Object[] args) throws Throwable {
        ...
        // It's unlikely that equals and hashCode will be used on accessor
        // implementations, but better safe than sorry.
        // Identity equality is enough, given that the mapper always returns the
        // same instance for a given accessor.
        if (m.equals(EQUALS)) {
            return proxy == args[0];
        }
