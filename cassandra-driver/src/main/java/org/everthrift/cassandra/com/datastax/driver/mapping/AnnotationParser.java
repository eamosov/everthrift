...
import org.everthrift.cassandra.com.datastax.driver.mapping.annotations.ClusteringColumn;
import org.everthrift.cassandra.com.datastax.driver.mapping.annotations.Column;
import org.everthrift.cassandra.com.datastax.driver.mapping.annotations.Computed;
import org.everthrift.cassandra.com.datastax.driver.mapping.annotations.Defaults;
import org.everthrift.cassandra.com.datastax.driver.mapping.annotations.Frozen;
import org.everthrift.cassandra.com.datastax.driver.mapping.annotations.FrozenKey;
import org.everthrift.cassandra.com.datastax.driver.mapping.annotations.FrozenValue;
import org.everthrift.cassandra.com.datastax.driver.mapping.annotations.Param;
import org.everthrift.cassandra.com.datastax.driver.mapping.annotations.PartitionKey;
import org.everthrift.cassandra.com.datastax.driver.mapping.annotations.Query;
import org.everthrift.cassandra.com.datastax.driver.mapping.annotations.QueryParameters;
import org.everthrift.cassandra.com.datastax.driver.mapping.annotations.Table;
import org.everthrift.cassandra.com.datastax.driver.mapping.annotations.Transient;
...
public class AnnotationParser implements EntityParser {
    ...
    private static <T> List<ColumnMapper<T>> createColumnMappers(List<Field> fields, EntityMapper.Factory factory, Class<T> klass,
        ...
        for (int i = 0; i < fields.size(); i++) {
            ...
            mappers.add(factory.createColumnMapper(klass, fieldDescriptor(field), mappingManager, columnCounter));
        }
        return mappers;
    }
    ...
    private static <T> Map<String, ColumnMapper<T>> createFieldMappers(List<Field> fields, EntityMapper.Factory factory, Class<T> klass,
        ...
        for (int i = 0; i < fields.size(); i++) {
            ...
            ColumnMapper<T> mapper = factory.createColumnMapper(klass, fieldDescriptor(field), mappingManager, columnCounter);
