...
//
//public class AbstractLoadableModelFactory<K extends Serializable,V extends DaoEntityIF<V>, A>  extends ModelFactoryDecorator<K,V> implements RwModelFactoryIF<K, V> {
//
...
//    };
//    
//    public AbstractLoadableModelFactory(RwModelFactoryIF<K,V> factory) {
//    	super(factory);
//    }
//
