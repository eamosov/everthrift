...
// }
//
// public static <T> T optimisticUpdate(UpdateFunction<T> updateFunction) throws
// OptimisticUpdateFailException, EntityNotFoundException, TException{
// return optimisticUpdate(updateFunction, MAX_ITERATIONS, MAX_TIMEOUT);
// }
//
// public static <T> T optimisticUpdate(UpdateFunction<T> updateFunction, int
// maxIteration, int maxTimeoutMillis) throws OptimisticUpdateFailException,
// EntityNotFoundException, TException{
// int i=0;
// T updated = null;
// do{
