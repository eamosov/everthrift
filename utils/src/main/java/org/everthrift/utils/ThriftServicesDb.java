 ...
 */
public class ThriftServicesDb {

    private static final Logger log = LoggerFactory.getLogger(ThriftServicesDb.class);

    public static ThriftServicesDb INSTANCE;
    ...
    public void setRoots(String roots) {
        this.roots = Arrays.asList(roots.split(","));
    }

    public ThriftServicesDb() {
        INSTANCE = this;
    }

    public ThriftServicesDb(String roots) {
        INSTANCE = this;
        setRoots(roots);
    }
