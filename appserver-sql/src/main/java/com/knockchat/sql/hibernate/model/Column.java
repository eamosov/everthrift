package com.knockchat.sql.hibernate.model;
...
import com.knockchat.sql.hibernate.ThriftPropertyAccessStrategy;
import com.knockchat.sql.hibernate.model.types.BoxType;
import com.knockchat.sql.hibernate.model.types.CustomTypeFactory;
import com.knockchat.sql.hibernate.model.types.DoubleListType;
import com.knockchat.sql.hibernate.model.types.IntegerListType;
import com.knockchat.sql.hibernate.model.types.JsonType;
import com.knockchat.sql.hibernate.model.types.LongDateType;
import com.knockchat.sql.hibernate.model.types.LongIntervalType;
import com.knockchat.sql.hibernate.model.types.LongListType;
import com.knockchat.sql.hibernate.model.types.LongTimestampType;
import com.knockchat.sql.hibernate.model.types.PointType;
import com.knockchat.sql.hibernate.model.types.ShortListType;
import com.knockchat.sql.hibernate.model.types.StringListType;
import com.knockchat.sql.hibernate.model.types.StringSetType;
import com.knockchat.sql.hibernate.model.types.StringUUIDType;
import com.knockchat.sql.hibernate.model.types.TBaseType;
import com.knockchat.sql.hibernate.model.types.TEnumTypeFactory;
import com.knockchat.sql.hibernate.model.types.TLongLongHstoreType;
import com.knockchat.sql.hibernate.model.types.UUIDStringListType;
...
public class Column {
    ...
    public boolean setHibernateType() {
    	...
    	if (javaClass == Long.class || javaClass == long.class) {            
    		...
    		hibernateType = com.knockchat.sql.hibernate.model.types.BinaryType.class.getCanonicalName();
    		...
    		if (columnType.contains("hstore")){
    			hibernateType =
    					propertyName.equals("deliveredAccountIds") ? com.knockchat.sql.hibernate.model.types.LongLongHstoreType.class.getCanonicalName() ://FIXME hack... 
    					com.knockchat.sql.hibernate.model.types.HstoreType.class.getCanonicalName();
    	...
    	}else if (jdbcType == Types.DATE && com.knockchat.sql.hibernate.model.types.DateType.isCompatible(javaClass)) {
    		
    		hibernateType = CustomTypeFactory.create(javaClass, com.knockchat.sql.hibernate.model.types.DateType.class).getCanonicalName();
